...
//
	...
	/**
	 * STATS(age).count	STATS(age).min	STATS(age).max	STATS(age).avg	STATS(age).sum
	 * @throws IOException
	...
	/**
	 * EXTENDED_STATS(age).count	EXTENDED_STATS(age).min	EXTENDED_STATS(age).max	EXTENDED_STATS(age).avg	EXTENDED_STATS(age).sum	
	 * EXTENDED_STATS(age).sum_of_squares	EXTENDED_STATS(age).variance	EXTENDED_STATS(age).std_deviation	
	 * EXTENDED_STATS(age).std_deviation_bounds
	 * @throws IOException
	 * @throws SqlParseException
	 * @throws SQLFeatureNotSupportedException
	 */
