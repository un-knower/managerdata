...
import com.ufc.shiro.util.PropertiesHelper;
...
public class ShiroFilterFactoryBean implements FactoryBean, BeanPostProcessor {
    ...
    public void setFilterChainDefinitionMap(Map<String, String> filterChainDefinitionMap) {
		...
		PropertiesHelper propertiesHelp = PropertiesHelper.getInstance();
    	String classPath = ShiroFilterFactoryBean.class.getClassLoader().getResource("").getPath().replace("WEB-INF"+File.separator+"classes"+File.separator, "permission");
		List<Map<String,String>> list = propertiesHelp.getFileNameInDirectory(new File(classPath), null, ".properties");
    	for (Map<String, String> map : list) {
    		 String fileName = map.get("name");
    		 List<Map<String,String>> permList = propertiesHelp.readProperties(classPath+File.separator+fileName);
    		 for (Map<String, String> permMap : permList) {
    			 String key = permMap.get("key");
    			 String value = permMap.get("value");
    			 customMap.put(key, value);
			}
		}
    	this.filterChainDefinitionMap = customMap;
    }
