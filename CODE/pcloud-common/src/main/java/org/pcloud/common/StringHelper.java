...
import org.pcloud.common.collection.ArrayHelper;
...
public final class StringHelper
{
  ...
  public static String replaceOnce(String template, String placeholder, String replacement)
  {
    ...
    return 
      ...
      template.substring(0, loc) + replacement + template.substring(loc + placeholder.length());
  }
  ...
  public static int[] locateUnquoted(String string, char character)
  {
    ...
    ArrayList<Object> locations = new ArrayList<Object>(20);
  ...
  public static String qualify(String prefix, String name)
  {
    ...
    return 
      ...
      prefix.length() + name.length() + 1 + prefix + '.' + name;
  }
  ...
  public static String generateAlias(String description, int unique)
  {
    return 
      ...
      generateAliasRoot(description) + Integer.toString(unique) + '_';
  }
