 ...
 * 类描述：扩展PreparedStatement,以便输出执行的sql语句
 */ 
public class LoggableStatement implements PreparedStatement {  
	...
	public String xss(Object text) {
		String value = text.toString();
		value = CustomStringEscapeUtils.escapeHtml(value);
		value = CustomStringEscapeUtils.escapeJavaScript(value);
		value = value.replaceAll("'", "&apos;");
		value = convertUnicode(value);
		return value;
	}
