...
class CustomEntities {
     ...
     * </p>
     */
    public static final CustomEntities XML;
     ...
     * </p>
     */
    public static final CustomEntities HTML32;
     ...
     * </p>
     */
    public static final CustomEntities HTML40;

    static {
        XML = new CustomEntities();
        XML.addEntities(BASIC_ARRAY);
        XML.addEntities(APOS_ARRAY);
    }

    static {
        HTML32 = new CustomEntities();
        HTML32.addEntities(BASIC_ARRAY);
        HTML32.addEntities(ISO8859_1_ARRAY);
    }

    static {
        HTML40 = new CustomEntities();
     ...
     */
    static void fillWithHtml40Entities(CustomEntities entities) {
    ...
    static abstract class MapIntMap implements CustomEntities.EntityMap {
    ...
    // package scoped for testing
    EntityMap map = new CustomEntities.LookupEntityMap();
    ...
    public String escape(String str) {
        ...
        try {
            this.customEscape(stringWriter, str);
        } catch (IOException e) {
     ...
     * @see Writer
     */
    public void customEscape(Writer writer, String str) throws IOException {
        int len = str.length();
        for (int i = 0; i < len; i++) {
            char c = str.charAt(i);
