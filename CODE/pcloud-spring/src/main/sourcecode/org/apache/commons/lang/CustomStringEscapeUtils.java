...
public class CustomStringEscapeUtils {
     ...
     */
    public CustomStringEscapeUtils() {
      super();
    }
    ...
    public static void escapeHtml(Writer writer, String string) throws IOException {
        ...
        CustomEntities.HTML40.customEscape(writer, string);
    }
    ...
    public static void unescapeHtml(Writer writer, String string) throws IOException {
        ...
        CustomEntities.HTML40.unescape(writer, string);
    }
     ...
     */
    public static void scapeXml(Writer writer, String str) throws IOException {
        if (writer == null ) {
            throw new IllegalArgumentException ("The Writer must not be null.");
        }
        if (str == null) {
        ...
        CustomEntities.XML.customEscape(writer, str);
    }
    ...
    public static String escapeXml(String str) {
        ...
        return CustomEntities.XML.escape(str);
    }
    ...
    public static void unescapeXml(Writer writer, String str) throws IOException {
        ...
        CustomEntities.XML.unescape(writer, str);
    }
    ...
    public static String unescapeXml(String str) {
        ...
        return CustomEntities.XML.unescape(str);
    }
